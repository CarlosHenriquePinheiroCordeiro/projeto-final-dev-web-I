    ...
    <body>
        <form action="acao.php" method="post">
            ...
            <fieldset>
                ...
                <br>
                <?= getLista('TipoUsuario', 'c_Usuario.TipoUsuario.codigo', 'Tipo do Usuário', Lista::TIPO_SELECT, $objeto ? $objeto->getUsuario()->getTipoUsuario()->getCodigo() : null, $isVisualizar)?>
            </select>
            </fieldset>
            <br>
            <?php
